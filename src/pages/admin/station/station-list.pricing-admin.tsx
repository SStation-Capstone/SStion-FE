...
import PricingAdminList from './pricing-list.container-admin';
...
export function StationAdminPricing({ clickOne, onClose, stationData }: PackagesFormProps) {
  ...
  return (
    ...
    >
      ...
      />
      <PricingAdminList check={clickOne} />
    </Modal>
  );
}
